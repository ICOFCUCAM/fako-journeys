...
<header class="jn-mast">
  <a class="jn-mark" href="/"><i>Afrinkong</i><b>Begin your journey</b></a>
...
<main class="jn jn-enq" id="main">
  <div class="jn-enq-grid">
    ...
    <form class="jn-enq-form" id="say" data-lead-mailto="%(mail)s" data-lead-form
      ...
      <p class="jn-enq-fine">Your details stay with us. No mailing list, no
        agents, nothing forwarded to third parties.</p>
